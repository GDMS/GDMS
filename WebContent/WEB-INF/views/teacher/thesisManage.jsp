			...
			<table class="table table-bordered">
				<thead>
					<tr>
						...
						<th style="vertical-align: middle;">可选专业</th>
				...
				<tbody>
					<c:forEach items="${thesises}" var="thesis" varStatus="st">
						<tr>
							...
							<td>${thesis.mode}</td>
							<td>${thesis.majorRestrict}</td>
							<td><a class="btn btn-primary btn-mini">修改</a>&nbsp;<a class="btn btn-danger btn-mini">删除</a></td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
		...
		<div class="span8 offset2">
			<div id="add" class="collapse in">
				<form:form modelAttribute="thesis" action="${ctx}/teacher/thesisManage/add" cssClass="form-horizontal">
					...
					<div class="control-group">
						<label class="control-label">限制专业:</label>
						<div class="controls">
